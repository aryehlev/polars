...
class PyLazyFrame:
    ...
    def serialize_template(self) -> bytes: ...
    @staticmethod
    def deserialize_template_and_bind(
        template: bytes, df: PyDataFrame
    ) -> PyLazyFrame: ...
    @staticmethod
    def deserialize_template_and_bind_multi(
        template: bytes, dfs: Sequence[PyDataFrame]
    ) -> PyLazyFrame: ...
